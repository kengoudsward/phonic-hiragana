...
# phonic-hiragana
# version 1.0
# written by Ken Goudsward, November 2010
# released under creative commons licence attrib non-commercial share-alike
...
=end
  ...
  stack :margin => 10 do
    ...
    button 'click here to convert to hiragana' do 
      ...
      hash3.each do |phonic, hirasym|
        @datastring.gsub!( phonic, hirasym ) # modify in place
      end
      hash2.each do |phonic, hirasym|
        @datastring.gsub!( phonic, hirasym ) # modify in place
      end
      hash1.each do |phonic, hirasym|
        @datastring.gsub!( phonic, hirasym ) # modify in place
      end
